...
githubrepo="LinuxGSM"
githubbranch="feature/config-dl"
...
fn_install_file(){
	...
	echo -e "Downloaded ${gamename} server script as '${serverscriptname}'."
	fn_install_default_configs "${serverscriptname}"
	echo -e ""
	echo -e "Make sure to the check installation settings if available before installing!"
	echo -e "Information about configuration:"
	echo -e "https://docs.linuxgsm.com/configuration/linuxgsm-config"
	echo -e ""
	if [ ! -d "${serverfiles}" ]; then
		echo "To install the server run:"
		echo -e "./${serverscriptname} install"
	else
		echo -e "Remember to check server ports"
		echo -e "./${serverscriptname} details"
	fi
	echo -e ""
	exit
}
...
# LinuxGSM server mode.
	...
	if [ "${shortname}" != "core-dep" ]; then
		...
		fn_install_default_configs "${selfname}"
