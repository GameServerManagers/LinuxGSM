...
fn_info_message_stn(){
	echo -e "netstat -atunp | grep Server_Lin"
	echo -e ""
	{
		echo -e "${lightblue}DESCRIPTION\tDIRECTION\tPORT\tPROTOCOL${default}"
		echo -e "> Game\tINBOUND\t${port}\tudp"
