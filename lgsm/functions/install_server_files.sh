...
fn_install_server_files(){
	if [ "${gamename}" == "Battlefield: 1942" ]; then
		...
		fileurl="https://s3.amazonaws.com/unrealtournament/UnrealTournament-Server-XAN-3315666-Linux.zip"; filedir="${tmpdir}"; filename="UnrealTournament-Server-XAN-3315666-Linux.zip";  executecmd="noexecute" run="norun"; force="noforce"; md5="cec4fb770251b33c93a97a558644de37"
