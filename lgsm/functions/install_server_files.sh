...
fn_install_server_files(){
	if [ "${gamename}" == "Unreal Tournament 99" ]; then
		...
		fileurl="https://s3.amazonaws.com/linuxgsm/cod2-lnxded-1.3-full.tar.bz2"; filedir="${tmpdir}"; filename="cod2-lnxded-1.3-full.tar.bz2";  executecmd="noexecute" run="norun"; force="noforce"; md5="078128f83d06dc3d7699428dc2870214"
	fi
