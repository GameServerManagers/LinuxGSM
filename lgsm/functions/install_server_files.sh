...
fn_install_server_files(){
	if [ "${gamename}" == "Battlefield: 1942" ]; then
		...
		fileurl="https://s3.amazonaws.com/unrealtournament/UnrealTournament-Server-XAN-3193528-Linux.zip"; filedir="${tmpdir}"; filename="UnrealTournament-Server-XAN-3193528-Linux.zip";  executecmd="noexecute" run="norun"; force="noforce"; md5="e3dd5853c4eb193674d5c832f60040d8"
