...
fn_install_server_files(){
	if [ "${gamename}" == "Unreal Tournament 99" ]; then
		...
		fileurl="https://s3.amazonaws.com/linuxgsm/codwaw-lnxded-1.7-full.tar.bz2"; filedir="${tmpdir}"; filename="codwaw-lnxded-1.7-full.tar.bz2";  executecmd="noexecute" run="norun"; force="noforce"; md5="0489697ff3bf678c109bfb377d1b7895"
	fi
