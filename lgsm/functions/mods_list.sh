...
mod_info_downtown=( MOD "rp_downtown_v4c_v2" "RP Downtown V4C V2" "https://github.com/Doc1337/rp_downtown_v4c_v2/raw/master/rp_downtown_v4c_v2.zip" "rp_downtown_v4c_v2.zip" "0" "LowercaseOff" "${systemdir}/maps" "OVERWRITE" "ENGINES" "Garry's Mod;" "NOTGAMES" "http://github.com/Doc1337/rp_downtown_v4c_v2" "The most popular DarkRP map!" )
# Oxidemod
...
mods_global_array=( "${mod_info_metamod[@]}" "${mod_info_sourcemod[@]}" "${mod_info_ulib[@]}" "${mod_info_ulx[@]}" "${mod_info_utime[@]}" "${mod_info_uclip[@]}" "${mod_info_acf[@]}" "${mod_info_acf_missiles[@]}" "${mod_info_acf_sweps[@]}" "${mod_info_advdupe2[@]}" "${mod_info_darkrp[@]}" "${mod_info_darkrpmodification[@]}" "${mod_info_downtown[@]}" "${mod_info_rustoxide[@]}" "${mod_info_hwoxide[@]}" "${mod_info_sdtdoxide[@]}" )
