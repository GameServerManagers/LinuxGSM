...
mod_info_lasertool=( MOD "lasertool" "Laser Tool" "https://github.com/dvdvideo1234/lasertool/archive/master.zip" "lasertool-master.zip" "0" "LowercaseOn" "${systemdir}/addons" "OVERWRITE" "ENGINES" "Garry's Mod;" "NOTGAMES" "https://github.com/dvdvideo1234/LaserTool" "Entity creating laser beam that can also reflected and even kill players" )
