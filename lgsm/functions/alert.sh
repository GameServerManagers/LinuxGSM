...
fn_alert_check_update(){
	...
	alerttitle="${selfname} - Update available"
	alertemoji="🎮"
	alertsound="1"
	alerturl="not enabled"
...
fn_alert_permissions(){
	...
	alerttitle="${selfname}: Permissions error"
	alertemoji="❗"
	alertsound="2"
	alerturl="not enabled"
...
fn_alert_config(){
	...
	alerttitle="${selfname} - New _default.cfg"
	alertemoji="📄"
	alertsound="1"
	alerturl="not enabled"
