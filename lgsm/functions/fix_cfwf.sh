...
configure_engine_ini ()  {
	echo "${engine_ini_config}" >> ${serverfiles}/Citadel/Saved/Config/LinuxServer/Engine.ini
}

configure_game_ini () {
	echo "${game_ini_config}" >> ${serverfiles}/Citadel/Saved/Config/LinuxServer/Game.ini
}
...
if [ ! -d ${serverfiles}/Citadel/Saved/Config/LinuxServer/ ]; then
	mkdir -p ${serverfiles}/Citadel/Saved/Config/LinuxServer/;
fi
...
if [ ! -f ${serverfiles}/Citadel/Saved/Config/LinuxServer/Game.ini ]; then
        touch /home/cfwfserver/serverfiles/Citadel/Saved/Config/LinuxServer/Game.ini;
	configure_game_ini

elif [ ! -s ${serverfiles}/Citadel/Saved/Config/LinuxServer/Game.ini ]; then
        configure_game_ini
fi