...
fn_stop_graceful_select(){
	if [ "${shortname}" == "sdtd" ]; then
		...
		fn_stop_graceful_goldsource
elif [ "${shortname}" == "av" ]||[ "${shortname}" == "fctr" ]||[ "${shortname}" == "jc2" ]||[ "${shortname}" == "jc3" ]||[ "${shortname}" == "mumble" ]||[ "${shortname}" == "sol" ]||[ "${engine}" == "unity3d" ]||[ "${engine}" == "unreal4" ]||[ "${engine}" == "unreal3" ]||[ "${engine}" == "unreal2" ]||[ "${engine}" == "unreal" ]||[ "${shortname}" == "wurm" ]; then
		fn_stop_graceful_ctrlc
