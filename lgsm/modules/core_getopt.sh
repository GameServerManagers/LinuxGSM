...
# Standard commands.
cmd_installr=("i;install" "command_install.sh" "Install the server.")
cmd_auto_installr=("ai;auto-install" "fn_autoinstall" "Install the server without prompts.")
cmd_startr=("st;start" "command_start.sh" "Start the server.")
cmd_stopr=("sp;stop" "command_stop.sh" "Stop the server.")
cmd_restartr=("r;restart" "command_restart.sh" "Restart the server.")
cmd_detailsr=("dt;details" "command_details.sh" "Display server information.")
cmd_postdetailsr=("pd;postdetails" "command_postdetails.sh" "Post details to termbin.com (removing passwords).")
cmd_backupr=("b;backup" "command_backup.sh" "Create backup archives of the server.")
cmd_update_linuxgsmr=("ul;update-lgsm;uf;update-modules" "command_update_linuxgsm.sh" "Check and apply any LinuxGSM updates.")
cmd_test_alertr=("ta;test-alert" "command_test_alert.sh" "Send a test alert.")
cmd_monitor=("m;monitor" "command_monitor.sh" "Check server status and restart if crashed.")
cmd_skeletonr=("sk;skeleton" "command_skeleton.sh" "Create a skeleton directory.")
